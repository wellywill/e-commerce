<form action="/daftarantrian/{{ $antrian->id }}" method="post">
    @csrf
    @method('delete')
    <div id="hs-antrian{{ $antrian->id }}"
            ...
            <div
                ...
                <div class="absolute top-2 end-2">
                    <button type="button"
                        ...
                        data-hs-overlay="#hs-antrian{{ $antrian->id }}">
                    ...
                    <div class="flex gap-x-4 md:gap-x-7">
                        ...
                        <div class="grow">
                            ...
                            <p class="text-slate-400">
                                Apakah anda yakin membatalkan antrian {{ $antrian->karyawan->nama }} ?
                            </p>
                        </div>
                    </div>
                </div>
