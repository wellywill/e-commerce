<form action="barangkeluar/{{ $data->id }}" method="post">
    @csrf
    @method('DELETE')
    <div id="hs-barangkeluar{{ $data->id }}"
            ...
            <div
                ...
                <div class="absolute top-2 end-2">
                    <button type="button"
                        ...
                        data-hs-overlay="#hs-barangkeluar{{ $data->id }}">
                    ...
                    <div class="flex gap-x-4 md:gap-x-7">
                        ...
                        <div class="grow">
                            ...
                            <p class="text-slate-400">
                                Yakin menghapus data {{ $data->inventory->nama_barang }}
                            </p>
                        </div>
                    </div>
                </div>
